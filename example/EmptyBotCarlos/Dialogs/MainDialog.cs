...
namespace EmptyBotCarlos.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> ActStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            var luisResult = await _luisRecognizer.RecognizeAsync<MainCognitiveModel>(stepContext.Context, cancellationToken);
            switch (luisResult.TopIntent().intent)
            {
                case MainCognitiveModel.Intent.Greeting:
        ...
        private static async Task ShowWarningForUnsupportedCities(ITurnContext context, CancellationToken cancellationToken)
        {
